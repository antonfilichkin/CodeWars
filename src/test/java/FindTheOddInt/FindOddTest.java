...
public class FindOddTest {
    ...
    public void findTest() throws Exception {
        Throwable exception = assertThrows(Exception.class, () -> FindOdd.findIt(new int[]{1,1,3,3,5,5}));
        assertEquals("Input Data Wrong", exception.getMessage());
        assertEquals(3, FindOdd.findIt(new int[]{1,1,3,3,3,5,5}));
